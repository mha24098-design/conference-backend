...
const channelName = 'private-conference.7';

// ضع هنا Sanctum Token للمستخدم المقبول في المؤتمر
const token = '29|5S6weJyPvbrkyXwx8fQaXooPSxp8elICHAtBlcCh745a02d7';

const ws = new WebSocket(
    `ws://192.168.1.44:8080/app/${appKey}`
);
